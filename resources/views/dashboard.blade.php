        ...
        <div class="flex flex-wrap items-center">
          <div class="relative w-full max-w-full flex-grow flex-1">
            ...
            <h2 class="text-blueGray-700 text-xl font-semibold">
              Admin OSIS SMP Islam Al-Azhar Cairo Banda Aceh
            </h2>
          </div>
        </div>
      </div>
      <div class="p-4 flex-auto">
        <p class="mb-4 text-blueGray-600">
          Selamat datang di dashboard admin. Dengan menggunakan dashboard ini, Anda dapat memantau dan mengelola data dengan lebih efektif.
        </p>
      </div>
    </div>
  </div>
